...
parser.add_argument(
    ...
    type=int,
    nargs=2,
    help="""epochs for feature extractor and feature composer.
    --epochs [A B], where A is the epochs for the feature extractor and B is the epochs for the feature composer"""
)
